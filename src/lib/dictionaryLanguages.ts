export const DICTIONARY_LANGUAGES = [
  ...
  { code: "tg", label: "Tajik" },
  { code: "ber-Latn", label: "Tamazight" },
  { code: "ber", label: "Tamazight (Tifinagh)" },
  { code: "ta", label: "Tamil" },
  { code: "tt", label: "Tatar" },
...
export const DEFAULT_TARGET_LANGUAGE = "bem";

export type DictionaryLanguageCode = (typeof DICTIONARY_LANGUAGES)[number]["code"];

export function getDictionaryLanguageLabel(code: string) {
  return DICTIONARY_LANGUAGES.find((language) => language.code === code)?.label ?? code;
}
